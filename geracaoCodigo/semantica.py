            ...
            if index != None:
                if index.type == "var":
                    ...
                    if e:
                        e.used = True
                        index = e.indice
                        if index != None and find_e.indice < int(float(index)):
                    ...
                    tipo = expressao
                    index = int(float(index.value))
                    if index < find_e.indice:
                        find_e.used = True
                        if find_e.tipo != tipo:
                            print("Aviso: A variavel " + find_e.nome + " é do tipo " + find_e.tipo +
                                  " mas esta recebendo um valor " + tipo + " -> Linha: " + str(soon.linha))
            else:
                try:
                    ...
                    if find_e.tipo != tipo:
                        print("Aviso: A variavel " + str(find_e.nome) + " é do tipo " + str(find_e.tipo) +
                            " mas esta recebendo um valor " + str(tipo) + " -> Linha: " + str(soon.linha))
